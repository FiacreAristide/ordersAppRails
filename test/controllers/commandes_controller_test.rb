...
class CommandesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create commande" do
    assert_difference("Commande.count") do
      post commandes_url, params: { commande: { client_id: @commande.client_id, dateCommande: @commande.dateCommande, etat: @commande.etat, montantTotal: @commande.montantTotal, nombreArticle: @commande.nombreArticle } }
    end
  ...
  test "should update commande" do
    patch commande_url(@commande), params: { commande: { client_id: @commande.client_id, dateCommande: @commande.dateCommande, etat: @commande.etat, montantTotal: @commande.montantTotal, nombreArticle: @commande.nombreArticle } }
