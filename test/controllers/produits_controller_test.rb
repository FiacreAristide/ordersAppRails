...
class ProduitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produit" do
    assert_difference("Produit.count") do
      post produits_url, params: { produit: { categorie_id: @produit.categorie_id, libelle: @produit.libelle, prixUnitaire: @produit.prixUnitaire } }
    end
  ...
  test "should update produit" do
    patch produit_url(@produit), params: { produit: { categorie_id: @produit.categorie_id, libelle: @produit.libelle, prixUnitaire: @produit.prixUnitaire } }
